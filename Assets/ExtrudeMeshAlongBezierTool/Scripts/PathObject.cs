 ...
 * 
 * PathObject is a class that holds reference to the Bézier curve, i.e, all the points that make up the total path
 ...
 * extruding the mesh along the Bézier curve.  
 * 
